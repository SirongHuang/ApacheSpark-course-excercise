...
val social = "src/main/resources/socialgraph.dat"
val code = "src/main/resources/coutrycodes.csv"
val data = spark.sparkContext.textFile("src/main/resources/allCountries.txt")
